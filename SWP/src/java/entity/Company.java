...
public class Company {
    ...
    public Company(int id, String name, String fname_d, String lname_d, String address, String country, String province, String city, int postal_code, String email, int phone, String pphone_d, int fax, String url) {
        this.id = id;
        this.name = name;
