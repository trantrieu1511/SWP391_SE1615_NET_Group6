...
public class DAOSalary extends DBConnect {
    ...
    public List<Salary> ListIndividualEmployeeSalary(String profile_id) {
        List<Salary> list = new ArrayList<>();
    ...
    public boolean editEmployeeSalary(Salary salary) {
    ...
    public boolean deleteEmployeeSalary(String profile_id) {
