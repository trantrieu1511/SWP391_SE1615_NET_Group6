<%-- 
    Document   : menu
    Created on : Jun 2, 2022, 4:41:29 PM
    Author     : DELL
--%>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">Rolland Webber</span>
                                                        completed
                                                        task <span class="noti-title">Patient and Doctor video
                                                            conferencing</span>
                                                    </p>
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    <li><a href="employee-dashboard.jsp">Dashboard (Employee)</a></li>
                                        <%--<c:if test="${sessionScope.acc.ReportsTo == null}">--%>
                                        <%
                                            if (pro.getReportsTo() == null) {
                                        %>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    <%--<c:if test="${sessionScope.acc.ReportsTo == null && sessionScope.acc.isadmin == false}">--%>
                                    <%
                                        if (pro.getReportsTo() == null && pro.isIsadmin() == false) {
                                    %>
                                    <li><a href="manager?do=listAllProfile&&user=${sessionScope.acc.username}">All Employees</a></li>
                                        <%}%>
                                        <%--</c:if>--%>
                                    <!--
                                    ...
                                    <li><a href="manager?do=attendance">Attendance (Manager)</a></li>
                                        <%}%>
                                        <%--</c:if>--%>
                                    <li><a href="employee?do=attendance&&user=${sessionScope.acc.username}">Attendance (Employee)</a></li>
